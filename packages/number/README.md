...
Aggregate package for the `number` module tree in [raindrops-on-roses](https://www.npmjs.com/package/raindrops-on-roses).
...
```ts
import { /* utilities */ } from "@raindrops-on-roses/number";
```
